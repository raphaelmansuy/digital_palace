...
- [OpenCoder LLM](./opencoder-llm.md) — Open-source code LLM family with 1.5B and 8B models, comprehensive training data and pipelines. See [LLMs](./llms.md), [Qwen Code](./qwen-code.md).
